...
report 50105 "Remittance Advice-Entries Cust"
{
    DefaultLayout = RDLC;
    WordLayout = './SRC/Layout/RemittanceAdviceEntriesCustom.docx';
    ...
    dataset
    {
        dataitem("Vendor Ledger Entry"; "Vendor Ledger Entry")
        {
            ...
            column(Vendo_Led_EntryPostingDate; "Posting Date") { }
            column(PostingDateCaption; PostingDateCaptionLbl) { }
            dataitem(VendLedgEntry2; "Vendor Ledger Entry")
            {
                DataItemTableView = sorting("Entry No.");
                column(Vendo_Led_Entry2PostingDate; "Posting Date") { }
                ...
                dataitem("Detailed Vendor Ledg. Entry"; "Detailed Vendor Ledg. Entry")
                {
                    ...
                    column(Dtld_Vendo_Led_Entry2PostingDate; "Posting Date") { }
